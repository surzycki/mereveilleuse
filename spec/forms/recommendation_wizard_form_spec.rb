# wip
#describe RecommendationWizardForm do
#  subject { RecommendationWizardForm.new Recommendation.new, practitioner }
#
...
#      expect { RecommendationWizardForm.new Recommendation.new, practitioner }.to_not raise_error
#    end
#
#    it 'implicit initialization of practitioner' do
#      allow(Practitioner).to receive(:new)
#      RecommendationWizardForm.new Recommendation.new
