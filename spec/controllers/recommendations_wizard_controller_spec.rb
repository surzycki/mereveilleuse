#describe RecommendationsWizardController do
#  let(:form)            { spy('form') }
...
#    allow(RecommendationWizardForm).to receive(:new).and_return form
#
...
#    context 'success' do
#      before do
#        post :create, recommendation_wizard_form: params, practitioner_id: ''
#      end
#
...
#    context 'success' do
#      before do
#        put :update, id: recommendation, recommendation_wizard_form: params
#      end
#      
#      it 'assigns form' do
#        expect(assigns[:form]).to eq form
